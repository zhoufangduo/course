...
<nav class="navbar navbar-fixed-top navbar-dark bg-inverse">
	...
	<ul class="nav navbar-nav">
		<li class="nav-item">
			<c:choose>
				<c:when test="${param.course == 'true'}">
					<a class="nav-link active" href="<%=basePath%>/admin/course/list?course=true">课程管理</a>
				</c:when>
				<c:otherwise>
					<a class="nav-link" href="<%=basePath%>/admin/course/list?course=true">课程管理</a>
				</c:otherwise>
			</c:choose>
		</li>
		<li class="nav-item">
