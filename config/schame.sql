...
CREATE TABLE COURSES(
	...
	`TYPE` INT(10) UNSIGNED NOT NULL COMMENT '课程的类型',
	PRIMARY KEY  (`ID`)
...
DROP TABLE IF EXISTS NAVSETTING;
CREATE TABLE NAVSETTING(
	 `ID` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
	 `PID` INT(11) UNSIGNED NOT NULL COMMENT '父菜单的节点',
	 `SEQ` INT(5) NOT NULL  COMMENT '顺序',
	 `NAME` VARCHAR(255) NOT NULL COMMENT '菜单名称',
	 `URL` VARCHAR(255) NOT NULL COMMENT 'url地址',
	 PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='导航栏标'